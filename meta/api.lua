...
---@field range number the number of items in the command range
---@field count number any count supplied
---@field reg string The optional regeister, if specified |reg|
---@field mods string Command modifiers
---@field smods string[] Command modifiers in a structured format.

---@param name string Name of the new command. The name must begin with an uppercase letter
---@param command string|fun(opt: ApiCreateUserCommand) the replacement text or Lua function to execute
