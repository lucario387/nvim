...
M.jdtls = function(bufnr)
  ...
  vim.keymap.set("n", "<F18>", function() -- F18 or S-F6
    require("jdtls").test_class({})
    vim.schedule(function()
      vim.cmd("stopinsert")
    end)
  end, { desc = "Test java class", buffer = bufnr })
  vim.keymap.set("n", "<F20>", function() -- F20 or S-F8
...
M.telescope = function()
  vim.keymap.set("n", "<leader>fw", "<cmd>Telescope live_grep prompt_title=false<CR>", { desc = "Live grep" })
  vim.keymap.set(
    "n",
    "<leader>fa",
