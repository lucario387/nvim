	...
	config.pylance = {
		default_config = {
			...
			on_attach = function(client, bufnr)
				...
				vim.api.nvim_buf_create_user_command(0, "PylanceSwitchInterpreter", function(opt)
        ...
        vim.api.nvim_buf_create_user_command(0, "PylanceCreateTypeStub", function(opts)
